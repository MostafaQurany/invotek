...
class _ProductsDataSource implements ProductsDataSource {
  ...
  @override
  Future<ProductResponse> uploadImage(int id, File image) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ProductResponse> bulkDeleteProducts(List<int> productIds) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = productIds;
    final _options = _setStreamType<ProductResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<ProductResponse> bulkUpdateStatus(Map<String, dynamic> request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
