...
class CreditInvoicesStateBuilder extends StatelessWidget {
  ...
  const CreditInvoicesStateBuilder({
    super.key,
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CreditInvoicesCubit, InvoicesState>(
      builder: (context, state) {
        print(
          '🏗️ CreditInvoicesStateBuilder building with state: ${state.runtimeType}',
        );
