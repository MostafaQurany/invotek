...
mixin _$InvoicesState {
 ...
 List<InvoiceEntity> get invoices; InvoiceEntity? get selectedInvoice; int get currentPage; int get totalPages;
...
@useResult
$Res call({
 List<InvoiceEntity> invoices, InvoiceEntity? selectedInvoice, int currentPage, int totalPages
});
...
as List<InvoiceEntity>,selectedInvoice: freezed == selectedInvoice ? _self.selectedInvoice : selectedInvoice // ignore: cast_nullable_to_non_nullable
as InvoiceEntity?,currentPage: null == currentPage ? _self.currentPage : currentPage // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages,  Failure? error)?  initial,TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages,  String? message)?  loading,TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)?  loaded,TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity created,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)?  createSuccess,TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity updated,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)?  updateSuccess,TResult Function( List<InvoiceEntity> invoices,  int deletedId,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)?  deleteSuccess,TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages,  Failure failure)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages,  Failure? error)  initial,required TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages,  String? message)  loading,required TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)  loaded,required TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity created,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)  createSuccess,required TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity updated,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)  updateSuccess,required TResult Function( List<InvoiceEntity> invoices,  int deletedId,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)  deleteSuccess,required TResult Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages,  Failure failure)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages,  Failure? error)?  initial,TResult? Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages,  String? message)?  loading,TResult? Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)?  loaded,TResult? Function( List<InvoiceEntity> invoices,  InvoiceEntity created,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)?  createSuccess,TResult? Function( List<InvoiceEntity> invoices,  InvoiceEntity updated,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)?  updateSuccess,TResult? Function( List<InvoiceEntity> invoices,  int deletedId,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages)?  deleteSuccess,TResult? Function( List<InvoiceEntity> invoices,  InvoiceEntity? selectedInvoice,  int currentPage,  int totalPages,  Failure failure)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that.invoices,_that.selectedInvoice,_that.currentPage,_that.totalPages,_that.error);case _LoadingInvoices() when loading != null:
return loading(_that.invoices,_that.selectedInvoice,_that.currentPage,_that.totalPages,_that.message);case _LoadedInvoices() when loaded != null:
...
class _Initial implements InvoicesState {
  const _Initial({final  List<InvoiceEntity> invoices = const [], this.selectedInvoice, this.currentPage = 1, this.totalPages = 1, this.error}): _invoices = invoices;
...
@override final  InvoiceEntity? selectedInvoice;
...
@override @useResult
$Res call({
 List<InvoiceEntity> invoices, InvoiceEntity? selectedInvoice, int currentPage, int totalPages, Failure? error
});
...
class _LoadingInvoices implements InvoicesState {
  const _LoadingInvoices({final  List<InvoiceEntity> invoices = const [], this.selectedInvoice, this.currentPage = 1, this.totalPages = 1, this.message}): _invoices = invoices;
...
@override @useResult
$Res call({
 List<InvoiceEntity> invoices, InvoiceEntity? selectedInvoice, int currentPage, int totalPages, String? message
});
...
class _LoadedInvoices implements InvoicesState {
  const _LoadedInvoices({required final  List<InvoiceEntity> invoices, this.selectedInvoice, required this.currentPage, required this.totalPages}): _invoices = invoices;
  

 final  List<InvoiceEntity> _invoices;
@override List<InvoiceEntity> get invoices {
  if (_invoices is EqualUnmodifiableListView) return _invoices;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_invoices);
}
...
class _CreateSuccessInvoices implements InvoicesState {
  const _CreateSuccessInvoices({required final  List<InvoiceEntity> invoices, required this.created, this.selectedInvoice, this.currentPage = 1, this.totalPages = 1}): _invoices = invoices;
...
@override @useResult
$Res call({
 List<InvoiceEntity> invoices, InvoiceEntity created, InvoiceEntity? selectedInvoice, int currentPage, int totalPages
});
...
invoices: null == invoices ? _self._invoices : invoices // ignore: cast_nullable_to_non_nullable
as List<InvoiceEntity>,created: null == created ? _self.created : created // ignore: cast_nullable_to_non_nullable
as InvoiceEntity,selectedInvoice: freezed == selectedInvoice ? _self.selectedInvoice : selectedInvoice // ignore: cast_nullable_to_non_nullable
as InvoiceEntity?,currentPage: null == currentPage ? _self.currentPage : currentPage // ignore: cast_nullable_to_non_nullable
as int,totalPages: null == totalPages ? _self.totalPages : totalPages // ignore: cast_nullable_to_non_nullable
as int,
  ));
...
class _UpdateSuccessInvoices implements InvoicesState {
  const _UpdateSuccessInvoices({required final  List<InvoiceEntity> invoices, required this.updated, this.selectedInvoice, this.currentPage = 1, this.totalPages = 1}): _invoices = invoices;
...
@override @useResult
$Res call({
 List<InvoiceEntity> invoices, InvoiceEntity updated, InvoiceEntity? selectedInvoice, int currentPage, int totalPages
});
...
invoices: null == invoices ? _self._invoices : invoices // ignore: cast_nullable_to_non_nullable
as List<InvoiceEntity>,updated: null == updated ? _self.updated : updated // ignore: cast_nullable_to_non_nullable
as InvoiceEntity,selectedInvoice: freezed == selectedInvoice ? _self.selectedInvoice : selectedInvoice // ignore: cast_nullable_to_non_nullable
as InvoiceEntity?,currentPage: null == currentPage ? _self.currentPage : currentPage // ignore: cast_nullable_to_non_nullable
as int,totalPages: null == totalPages ? _self.totalPages : totalPages // ignore: cast_nullable_to_non_nullable
as int,
...
class _DeleteSuccessInvoices implements InvoicesState {
  const _DeleteSuccessInvoices({required final  List<InvoiceEntity> invoices, required this.deletedId, this.selectedInvoice, this.currentPage = 1, this.totalPages = 1}): _invoices = invoices;
...
@override @useResult
$Res call({
 List<InvoiceEntity> invoices, int deletedId, InvoiceEntity? selectedInvoice, int currentPage, int totalPages
});
...
invoices: null == invoices ? _self._invoices : invoices // ignore: cast_nullable_to_non_nullable
as List<InvoiceEntity>,deletedId: null == deletedId ? _self.deletedId : deletedId // ignore: cast_nullable_to_non_nullable
...
class _FailureInvoices implements InvoicesState {
  const _FailureInvoices({final  List<InvoiceEntity> invoices = const [], this.selectedInvoice, this.currentPage = 1, this.totalPages = 1, required this.failure}): _invoices = invoices;
...
@override @useResult
$Res call({
 List<InvoiceEntity> invoices, InvoiceEntity? selectedInvoice, int currentPage, int totalPages, Failure failure
});
