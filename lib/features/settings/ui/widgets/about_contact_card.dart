...
class AboutContactCard extends StatefulWidget {
  const AboutContactCard({super.key});

  @override
  State<AboutContactCard> createState() => _AboutContactCardState();
}

class _AboutContactCardState extends State<AboutContactCard> {
