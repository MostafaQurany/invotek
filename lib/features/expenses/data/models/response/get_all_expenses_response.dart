...
part 'get_all_expenses_response.g.dart';

@JsonSerializable()
class GetAllExpensesResponse {
  @JsonKey(name: 'current_page')
  final int? currentPage;
  final List<ExpenseApiModel>? data;
  ...
  factory GetAllExpensesResponse.fromJson(Map<String, dynamic> json) =>
      _$GetAllExpensesResponseFromJson(json);

  Map<String, dynamic> toJson() => _$GetAllExpensesResponseToJson(this);
}
