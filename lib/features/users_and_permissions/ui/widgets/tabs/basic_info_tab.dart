...
class BasicInfoTab extends StatelessWidget {
  ...
  final VoidCallback? onPositionSubmitted;
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField(
                  ...
                  textInputAction: TextInputAction.next,
                  onSubmitted: (_) => onEmailSubmitted?.call(),
                ),
                ...
                CustomTextField(
                  ...
                  textInputAction: positionController != null 
                      ? TextInputAction.next 
                      : (showPasswordFields ? TextInputAction.next : TextInputAction.done),
                  onSubmitted: (_) {
                    if (positionController != null) {
                      onPhoneSubmitted?.call();
                    } else if (showPasswordFields && passwordController != null) {
                      onPasswordSubmitted?.call();
                    }
                  },
                ),
                ...
                if (positionController != null)
                  CustomTextField(
                    ...
                    textInputAction: showPasswordFields ? TextInputAction.next : TextInputAction.done,
                    onSubmitted: (_) {
                      if (showPasswordFields && passwordController != null) {
                        onPositionSubmitted?.call();
                      }
                    },
                  ),
                ...
                if (showPasswordFields && passwordController != null) ...[
                  ...
                  CustomTextField(
                    ...
                    onSubmitted: (_) => onConfirmPasswordSubmitted?.call(),
                  ),
                ],
